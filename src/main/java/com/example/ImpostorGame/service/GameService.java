...
public class GameService {
    ...
    private final List<WordPair> wordPairs = List.of(
            ...
            new WordPair("Ocean", "Lake"),
            new WordPair("Boat", "Ship"),
            ...
            new WordPair("Juice", "Smoothie"),
            new WordPair("Bread", "Toast"),
            new WordPair("Rice", "Pasta"),
            new WordPair("Noodles", "Spaghetti"),
            ...
            new WordPair("Crocodile", "Alligator"),
            new WordPair("Panda", "Koala"),
            new WordPair("Penguin", "Flamingo"),
            new WordPair("Football", "Cricket"),
            new WordPair("Tennis", "Badminton"),
            ...
            new WordPair("Cucumber", "Lettuce"),
            new WordPair("Burger", "Sandwich"),
            new WordPair("Hotdog", "Sausage"),
            new WordPair("Taco", "Burrito"),
            new WordPair("Sushi", "Ramen"),
            new WordPair("Soup", "Salad"),
            new WordPair("Steak", "Kebab"),
            new WordPair("Pancake", "Waffle"),
            new WordPair("Donut", "Muffin"),
